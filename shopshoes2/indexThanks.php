...
if(isset($_GET['partnerCode'])){
    ...
    if(isset($_GET['diachi'])){
        ...
        WHERE tbl_sodiachi.id_dangky=$id_khachhang 
        ...
        VALUES('".$id_khachhang."','".$id."','".$code_order."',2,'".$_thanhtoan."','".$date."','".$diachi."' ) ";
    }
    
    if(isset($_GET['dangky'])){
        $id = $_GET['dangky'];
        $getSoDiaChi = "SELECT * FROM tbl_dangky,province,district,wards 
        WHERE tbl_dangky.id_dangky=$id_khachhang 
        ...
        VALUES('".$id."','".$code_order."',2,'".$_thanhtoan."','".$date."','".$diachi."' ) ";
    }
