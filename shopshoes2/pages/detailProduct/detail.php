    ...
    <div class="grid wide">
        <ul class="header-list">
            <li class="header-item">
                <span>Kết nối</span>
                <a href="https://www.facebook.com/#/" class="header-item-icon"><i class="fa-brands fa-facebook"></i></a>
                <a href="https://www.instagram.com/#/" class="header-item-icon"><i class="fa-brands fa-instagram"></i></a>
            ...
            ?>
                <div class="col l-2-4 m-4 c-6 container-product-all-item">
                    <form action="pages/content/addProduct.php?id=<?php echo $row['id_sanpham'] ?>&msp=<?php echo $row['masanpham'] ?>" method="POST">
                        <a class="container-product-item" href="../../shopshoes2/indexDetail.php?id=<?php echo $row['id_sanpham'] ?>&MSP=<?php echo $row['masanpham'] ?>&danhmuc=<?php echo $row['id_danhmuc'] ?>">
                            <?php
                            if ($row['loaihang'] == 'new') {
                            ?>
                            ...
                            <div class="price-cart">
                                ...
                                ?>
                                <a href="../../shopshoes2/indexDetail.php?id=<?php echo $row['id_sanpham'] ?>&MSP=<?php echo $row['masanpham'] ?>" class="price-cart-icon">
