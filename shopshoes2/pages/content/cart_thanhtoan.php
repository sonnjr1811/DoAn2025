        ...
        <div class="chondiachi-thaydoi">
            ...
            ?>
                <div class="form-thaydoi">
                    <a href="http://localhost/shopshoes2/indexOrder.php?sum=<?php echo $_GET['sum'] ?>&sl=<?php echo $_GET['sl'] ?>&idDiaChi=<?php echo $code ?> ">
                        ...
                        <div class="QL_content-right-infomation-address">
                            <div class="QL_content-right-infomation-address-top">
                                ...
                                <label>
                                    ...
                                    <a href="http://localhost/shopshoes2/indexOrder.php?sum=<?php echo $_GET['sum'] ?>&sl=<?php echo $_GET['sl'] ?>">Mặc định</a>
                                </label>
                            </div>
